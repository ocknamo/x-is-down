...
const translations = {
  ja: {
    ...
    loginWithNip07Desc: 'ブラウザ拡張ウォレットでログイン',
    loginWithNosskey: 'nosskey.app（パスキー）',
    loginWithNosskeyDesc: 'パスキーでnosskey.appのアカウントを使う',
  ...
  en: {
    ...
    loginWithNip07Desc: 'Log in with a browser wallet extension',
    loginWithNosskey: 'nosskey.app (passkey)',
    loginWithNosskeyDesc: 'Use your nosskey.app account with a passkey',
